...
* The original package name 'com.application.springboot.basics.springboot-in-10-steps' is invalid and this project uses 'com.application.springboot.basics.springbootin10steps' instead.
